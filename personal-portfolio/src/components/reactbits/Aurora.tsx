...
export default function Aurora(props: AuroraProps) {
  ...
  // Fixed: update the ref in an effect instead of during render
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    // program is declared here (not const) because resize() below is a
    // closure that reads `program` before it gets assigned a value
